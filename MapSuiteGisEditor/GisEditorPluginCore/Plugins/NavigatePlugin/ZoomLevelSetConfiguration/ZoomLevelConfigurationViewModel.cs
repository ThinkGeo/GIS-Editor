...
{
    public class ZoomLevelConfigurationViewModel : ViewModelBase
    {
        private ObservableCollection<ZoomLevelViewModel> zoomLevelSetViewModel;
        private ZoomLevelViewModel selectedZoomLevel;
        ...
        public ZoomLevelViewModel SelectedZoomLevel
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(()=>SelectedZoomLevel);
            }
        }

        public ObservableCollection<ZoomLevelViewModel> ZoomLevelSetViewModel
        {
