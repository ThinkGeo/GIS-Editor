...
{
    /// <summary>
    /// Interaction logic for ConfigTabFileUserControl.xaml
    /// </summary>
    public partial class ConfigTabFileUserControl : CreateFeatureLayerUserControl
    {
        private ConfigLayerStructureViewModel configLayerStructureViewModel;

        public ConfigTabFileUserControl(FeatureLayer featureLayer)
        {
            InitializeComponent();
