...
namespace ThinkGeo.MapSuite.GisEditor.Plugins
{
    class KmlGeoCanvas : GeoCanvas
    {
        ...
        public static int ZHeight = 0;
        public static AltitudeMode Mode = AltitudeMode.ClampToGround;
        ...
        private string GetTextStyleKml(int id, GeoColor color, float fontSize)
        {
            StringBuilder styleBuilder = new StringBuilder();
            styleBuilder.AppendLine();
            styleBuilder.AppendFormat(@"<Style id=""{0}"">", id);
            ...
            styleBuilder.AppendLine();
            styleBuilder.AppendFormat(@"<scale>{0}</scale>", fontSize);
            styleBuilder.AppendLine();
            styleBuilder.AppendLine(@"</LabelStyle>");
