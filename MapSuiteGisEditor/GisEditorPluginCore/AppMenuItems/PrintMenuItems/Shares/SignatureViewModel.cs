...
namespace ThinkGeo.MapSuite.GisEditor.Plugins
{
    public class SignatureViewModel : ViewModelBase
    {
        ...
        private LabelPrinterLayer signaturePrinterLayer;

        public SignatureViewModel()
            : this(string.Empty, new LabelPrinterLayer())
        {
        }
        ...
        public LabelPrinterLayer SignaturePrinterLayer
        {
            get { return signaturePrinterLayer; }
            set { signaturePrinterLayer = value; }
        }
    }
}
