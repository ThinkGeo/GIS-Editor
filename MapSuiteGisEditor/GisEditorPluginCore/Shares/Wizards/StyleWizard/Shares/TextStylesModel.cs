...
{
    [Serializable]
    public class TextStylesModel : Collection<StyleCheckableItemModel>
    {
        public TextStylesModel()
        {
            foreach (var stylePlugin in GisEditor.StyleManager.GetStylePlugins(StyleCategories.Label))
            {
                ...
                item.Preview = Extensions.AllStylePluginPreviews[item.ProviderName + "_text"];
                Add(item);
            }
            ...
            //{
            //    Name = "Label Style",
            //    ProviderName = "TextComponentStyle",
            //    Description = Properties.Resources.TextSimpleStyle,
            ...
            //    Description = Properties.Resources.TextFilterStyle,
