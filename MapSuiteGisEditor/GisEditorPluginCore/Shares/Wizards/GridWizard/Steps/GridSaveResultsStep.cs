...
{
    public class GridSaveResultsStep : WizardStep<GridWizardShareObject>
    {
        private GridSaveResultsUserControl content;

        public GridSaveResultsStep()
        {
            ...
            Description = GisEditor.LanguageManager.GetStringResource("ToolsGridWizardStepFourSaveResults");
            content = new GridSaveResultsUserControl();
            Content = content;
        }
        ...
        {
            var viewModel = content.DataContext as GridWizardShareObject;
            bool result = false;
            if (viewModel != null)
            {
