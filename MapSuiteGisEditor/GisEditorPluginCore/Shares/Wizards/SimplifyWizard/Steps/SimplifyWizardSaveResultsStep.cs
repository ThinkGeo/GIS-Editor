...
{
    [Serializable]
    public class SimplifyWizardSaveResultsStep : WizardStep<SimplifyWizardShareObject>
    {
        [NonSerialized]
        private SimplifyWizardSaveResultsUserControl content;

        public SimplifyWizardSaveResultsStep()
        {
            ...
            content = new SimplifyWizardSaveResultsUserControl();
            Content = content;
        }

        protected override bool CanMoveToNextCore()
        {
            var viewModel = content.DataContext as SimplifyWizardShareObject;
            bool result = false;
            if (viewModel != null)
            {
        ...
        protected override bool LeaveCore(SimplifyWizardShareObject parameter)
        {
