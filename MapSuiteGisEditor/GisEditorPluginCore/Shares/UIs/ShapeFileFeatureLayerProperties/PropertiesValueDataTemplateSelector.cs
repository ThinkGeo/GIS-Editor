...
{
    [Serializable]
    public class PropertiesValueDataTemplateSelector : DataTemplateSelector
    {
        public override DataTemplate SelectTemplate(object item, System.Windows.DependencyObject container)
        {
            ...
            if (valuePropertyInfo != null)
            {
                ...
                else if (itemValue is IEnumerable<KeyValuePair<string, string>> || itemValue is IEnumerable<string>)
                {
