...
namespace ThinkGeo.MapSuite.GisEditor.Plugins
{
    ...
    internal static class ColorHelper
    {
        ...
        public static Color Complementary(Color c)
        {
            ...
            return HsvToColor(c.A, newHue, hsv[1], hsv[2]);
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static Color HsvToColor(byte alpha, byte hue, byte saturation, byte value)
        {
            double r, g, b;
        ...
        /// <returns></returns>
        public static Color HsvToColor(double alpha, double hue, double sat, double val)
        {
            int i;
            double aa, bb, cc, f;
            double r, g, b;
