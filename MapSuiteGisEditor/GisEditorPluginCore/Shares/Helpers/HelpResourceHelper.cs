...
{
    [Obfuscation]
    public static class HelpResourceHelper
    {
        public static FrameworkElement GetHelpButton(string resourceKey, HelpButtonMode helpButtonMode, RelayCommand clickCommand = null)
        {
            string helpUri = GisEditor.LanguageManager.GetStringResource(resourceKey);
            return HelpButtonHelper.GetHelpButton(helpUri, helpButtonMode, clickCommand);
        }
