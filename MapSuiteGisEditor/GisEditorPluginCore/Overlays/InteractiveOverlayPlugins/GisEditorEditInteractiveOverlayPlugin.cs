...
{
    [Serializable]
    internal class GisEditorEditInteractiveOverlayPlugin : InteractiveOverlayPlugin
    {
        public GisEditorEditInteractiveOverlayPlugin()
        { }

        protected override Type GetInteractiveOverlayTypeCore()
        {
            return typeof(GisEditorEditInteractiveOverlay);
        }

        protected override void DisableCore(InteractiveOverlay interactiveOverlay)
        {
            var overlay = interactiveOverlay as GisEditorEditInteractiveOverlay;
            if (overlay != null)
            {
