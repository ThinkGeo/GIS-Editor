...
{
    /// <summary>
    /// Interaction logic for StyleOptions.xaml
    /// </summary>
    public partial class StyleSettingUserControl : SettingUserControl
    {
        public StyleSettingUserControl(string title, string category, string description)
            : base(title, category, description)
        {
            Title = title;
            Category = category;
