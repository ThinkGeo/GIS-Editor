...
{
    [Serializable]
    public class ValueStylePlugin : StylePlugin
    {
        public ValueStylePlugin()
            : base()
        {
            Name = GisEditor.LanguageManager.GetStringResource("ValueStylePluginName");
            Description = GisEditor.LanguageManager.GetStringResource("ValueStylePluginDescription");
