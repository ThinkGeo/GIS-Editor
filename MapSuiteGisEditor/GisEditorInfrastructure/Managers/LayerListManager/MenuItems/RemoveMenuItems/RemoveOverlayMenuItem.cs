...
namespace ThinkGeo.MapSuite.GisEditor
{
    internal partial class LayerListMenuItemHelper
    {
        ...
        private static void RemoveOverlay()
        {
            ...
            if (needRefresh)
            {
                GisEditor.UIManager.InvokeRefreshPlugins(new RefreshArgs(GisEditor.LayerListManager.SelectedLayerListItems, RefreshArgsDescriptions.RemoveOverlayDescription));
            }
        }
